            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.bihar.vehiclePermitType.map((type) => {
                    return (
              ...
              <div className='form__control'>
                ...
                >
                  ...
                  {fields.bihar.paymentMode.map((pay) => {
                    return (
                ...
                <div className='col-sm-6'>
                  ...
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.bihar.permitType.map((type) => {
                        return (
                          <option key={type.name} value={type.name}>
                            {type.name}
                          </option>
                ...
                <div className='col-sm-6'>
                  ...
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.bihar.borderBarrier.map((dist) => {
                        return (
                ...
                <div className='col-sm-6'>
                  ...
                  <div className='form__control'>
                    ...
                    >
                      ...
                      {fields.bihar.checkPostName.map((checkPost) => {
                        return (
