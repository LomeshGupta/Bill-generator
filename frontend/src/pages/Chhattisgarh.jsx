    ...
    <>
      ...
      <div className="text-center">
        <p className="login-heading mt-4">
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>CHHATTISGARH</span>
        </p>
      </div>
            ...
            <div className="col-6">
              ...
              <div className="form__control">
                ...
                >
                  ...
                  {fields.chhattisgarh.vehiclePermitType.map((type) => {
                    return (
              ...
              <div className="form__control">
                ...
                >
                  ...
                  {fields.chhattisgarh.borderBarrier.map((type) => {
                    return (
                      <option value={type.name} key={type.name}>
                        {type.name}
                      </option>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.chhattisgarh.permitType.map((type) => {
                        return (
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.chhattisgarh.serviceType.map((type) => {
