    ...
    <>
      ...
      <div className="text-center">
        <p className="login-heading mt-4">
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>JHARKHAND</span>
        </p>
      </div>
            ...
            <div className="col-6">
              ...
              <div className="form__control">
                ...
                >
                  ...
                  {fields.jharkhand.vehiclePermitType.map((type) => {
                    return (
            ...
            <div className="col-6">
                ...
                <div className="col-sm-6">
                  ...
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.jharkhand.permitType.map((type) => {
                        return (
              ...
              <div className="form__control">
                ...
                >
                  ...
                  {fields.jharkhand.borderBarrier.map((type) => {
                    return (
                      <option value={type.name} key={type.name}>
                        {type.name}
                      </option>
