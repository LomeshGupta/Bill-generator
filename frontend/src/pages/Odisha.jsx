    ...
    <>
      ...
      <div className="text-center">
        <p className="login-heading mt-4">
          <b>BORDER TAX PAYMENT FOR ENTRY INTO</b> <span>ODISHA</span>
        </p>
      </div>
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.odisha.vehiclePermitType.map((type) => {
                        return (
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields?.odisha?.taxMode.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.odisha.serviceType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.odisha.permitType.map((type) => {
                        return (
                          <option value={type.name} key={type.name}>
                            {type.name}
                          </option>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.odisha.purposeOfJourney.map((dist) => {
                        return (
                ...
                <div className="col-sm-6">
                  <div className="form__control">
                    ...
                    >
                      ...
                      {fields.odisha.enteringDistrict.map((dist) => {
                        return (
                          <option key={dist.name} value={dist.name}>
                            {dist.name}
                          </option>
